...
![累计收益曲线](cumulative-performance.png?v=f0634b4759b9)
...
- 本次构建里的最新事件/快照：**2026-07-19T12:35:02.029Z**
...
- `api-v1-order.csv`：**43,251** 行
- `api-v1-execution-tradeHistory.csv`：**173,434** 行
- `api-v1-user-walletHistory.csv`：**17,484** 行
- 时间范围：**2020-05-01 → 2026-07-19**
...
- 最新调整后钱包等值财富（XBT+USDt 范围）：**98.13610009 XBT**（相对基准 **53.348191x**）
- 最新调整后按保证金计价财富（XBT+USDt 范围）：**99.78565178 XBT**（相对基准 **54.244911x**）
