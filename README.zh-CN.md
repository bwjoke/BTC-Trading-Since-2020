...
![累计收益曲线](cumulative-performance.png?v=dc2dc2d11acf)
...
这**不是**一份为 HFT、CLOB 微观结构研究或毫秒级价格预测准备的数据集。
它是一份带时间戳的、手工、主观、以看 K 线为主的 BTC 交易档案，更适合研究在不可消除的不确定性里，交易者如何做仓位调整、风险管理、回撤处理、策略应对与长期复利。
